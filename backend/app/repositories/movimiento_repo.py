...
async def create_movimiento(
    ...
    comercio_raw: str | None = None,
    comercio_norm: str | None = None,
    regla_comercio_id: int | None = None,
    ...
    mov = Movimiento(
        ...
        ComercioRaw=comercio_raw,
        ComercioNorm=comercio_norm,
        ComercioId=comercio_id,
        ReglaComercioId=regla_comercio_id,
...
def _mov_to_dict(
    ...
    return {
        ...
        "monto": monto,
        "Monto": monto,
        "comercio": str(mov.ComercioRaw or "").strip() or descripcion,
        "Comercio": str(mov.ComercioRaw or "").strip() or descripcion,
        "comercioRaw": str(mov.ComercioRaw or "").strip(),
        "ComercioRaw": str(mov.ComercioRaw or "").strip(),
        "comercioNorm": str(mov.ComercioNorm or "").strip(),
        "ComercioNorm": str(mov.ComercioNorm or "").strip(),
        "comercioId": mov.ComercioId,
        "ReglaComercioId": mov.ReglaComercioId,
        "descripcion": descripcion,
        "Descripcion": descripcion,
